...
public class constants {
	...
	public static class ObjectConstants {
		...
		public static final int SPIKE_WIDTH = (int) (Game.SCALE * POTION_WIDTH_DEFAULT);
		public static final int SPIKE_HEIGHT = (int) (Game.SCALE * POTION_HEIGHT_DEFAULT);
...
//		public static final int CRABNINJA_WIDTH_DEFAULT = 74;
//		public static final int CRABNINJA_HEIGHT_DEFAULT = 70;
//		public static final int CRABNINJA_WIDTH = (int)(CRABNINJA_WIDTH_DEFAULT * Game.SCALE);
//		public static final int CRABNINJA_HEIGHT = (int)(CRABNINJA_HEIGHT_DEFAULT * Game.SCALE);
//		public static final int CRABNINJA_DRAWOFFSETX = (int) (20 * Game.SCALE);
//		public static final int CRABNINJA_DRAWOFFSETY = (int) (18 * Game.SCALE);
