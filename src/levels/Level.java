...
public class Level {
	...
	//private ArrayList<CrabNinja> crabninjas = new ArrayList<>();
...
//		}
	...
	private void loadEntities(int greenValue, int x, int y) {
		...
		//case CRABNINJA -> crabninjas.add(new CrabNinja(x * Game.TILES_SIZE, y * Game.TILES_SIZE));
...
//	public ArrayList<CrabNinja> getCrabNinja() {
//		return crabninjas;
//	}
