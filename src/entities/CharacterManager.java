...
public class CharacterManager {
    ...
    private void initSpriteAmounts() {
        ...
        sasukeSpriteAmounts.put(PlayerConstants.HIT,6);
        sasukeSpriteAmounts.put(PlayerConstants.ATTACK_1, 6);
        sasukeSpriteAmounts.put(PlayerConstants.JUMP, 6);
        sasukeSpriteAmounts.put(PlayerConstants.ATTACK_JUMP_1, 6);
        sasukeSpriteAmounts.put(PlayerConstants.ATTACK_JUMP_2, 5);
        sasukeSpriteAmounts.put(PlayerConstants.DEAD, 6);
