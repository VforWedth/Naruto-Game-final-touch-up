...
public class EnemyManager {
	...
	private BufferedImage[][] crabbyArr, pinkstarArr, sharkArr, crabNinjaArr;
...
//		for (CrabNinja p : currentLevel.getCrabNinja())
//			if (p.isActive()) {
//				p.update(lvlData, playing);
//				isAnyActive = true;
//			}
...
//	for (CrabNinja p : currentLevel.getCrabNinja())
//		if (p.isActive()) {
//			g.drawImage(crabNinjaArr[p.getState()][p.getAniIndex()], (int) p.getHitBox().x - xLvlOffset - CRABNINJA_DRAWOFFSETX + p.flipX(),
//					(int) p.getHitBox().y - CRABNINJA_DRAWOFFSETY - 20 + (int) p.getPushDrawOffset(), CRABNINJA_WIDTH * p.flipW(), CRABNINJA_HEIGHT, null);
//			p.drawHitbox(g, xLvlOffset);
//		}
//}
...
//			}
	...
	private void loadEnemyImgs() {
		...
		//crabNinjaArr = getImgArr(LoadSave.GetSpriteAtlas(LoadSave.CRAB_NINHJA), 8, 5, CRABNINJA_WIDTH_DEFAULT, CRABNINJA_HEIGHT_DEFAULT);
	}
